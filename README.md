...
## 如何发起技术支持请求
- 请在[support](https://github.com/fluttify-project/support/issues/new?assignees=yohom&labels=&template=------.md&title=)仓库*按模板*新建issue来发起技术支持请求.
...
### Bug修复 ¥100+
- 根据bug修复难度确认不同的费用.
- 确认是bug修复后会在[support](https://github.com/fluttify-project/support/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc)仓库新建issue来跟踪完成情况.
...
- 根据业务复杂度确认不同的费用, 确认功能后在[support](https://github.com/fluttify-project/support/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc)新建issue跟踪完成情况.
